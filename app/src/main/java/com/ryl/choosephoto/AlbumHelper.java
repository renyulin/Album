...
public class AlbumHelper {
    ...
    public List<ImageBucket> getImagesBucketList(boolean refresh) {
        ...
        allImageBucket.bucketName = "All pictures";
        allImageBucket.count = -1;
        allImageBucket.imageList = new ArrayList<>();
        while (itr.hasNext()) {
            Entry<String, ImageBucket> entry = itr.next();
            tmpList.add(entry.getValue());
            allImageBucket.imageList.addAll(entry.getValue().imageList);
        }
